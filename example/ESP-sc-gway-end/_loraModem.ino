...
// Copyright (c) 2016-2020 free version for ESP8266
//
...
//      mc1 = 0x92;        // SX1276_MC1_BW_125==0x70 | SX1276_MC1_CR_4_5==0x02
    }
...
//    int32_t delayTmst = (int32_t)(LoraDown->tmst - micros());   1375291217

  int32_t delayTmst = (int32_t)(LoraDown->tmst - micros()) + gwayConfig.txDelay - 35000;

//  Serial.println(LoraDown->tmst);
//  int32_t delayTmst = (int32_t)(LoraDown->tmst - micros());
//  Serial.println(delayTmst);
  
  // delayTmst based on txDelay and spreading factor   411409
...
{
  //  Serial.println("Send down to node ");
  //  Serial.print("LoraDown->sfTx: ");
  //  Serial.println(LoraDown->sfTx);
  //  Serial.print("LoraDown->freq: ");
  //  Serial.println(LoraDown->freq);
  //  Serial.print("LoraDown->powe: ");
  //  Serial.println(LoraDown->powe);
...
//  setPow(15);
  ...
  if(region == "US915")
  {
    writeRegister(REG_MODEM_CONFIG1, (uint8_t) 0x92);
  }
  

  // 7. prevent node to node communication
  writeRegister(REG_INVERTIQ, (uint8_t) (LoraDown->iiq));	// 0x33, (0x27 or 0x40)
//  writeRegister(REG_INVERTIQ, (uint8_t) 0x40);  // 0x33, (0x27 or 0x40)
...
//  uint8_t _data[] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x08, 0x08};
...
//  writeRegister(REG_PAYLOAD_LENGTH, (uint8_t) 10);    // set 0x22, max 0x40==64Byte long
