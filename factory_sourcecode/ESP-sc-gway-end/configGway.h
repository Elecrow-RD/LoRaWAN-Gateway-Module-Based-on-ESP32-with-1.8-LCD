...
#define NTP_TIMESERVER  "cn.pool.ntp.org"
...
//#define _TTNSERVER "loragw.things.qcloud.com"       // 腾讯 IoT Server
//#define _TTNSERVER "eu1.cloud.thethings.network"    // TTN  Server 
//#define _TTNSERVER "gateway-udp-uplink.smartkit.io" //一个企业开发的 server
//#define _TTNSERVER "lora.ansitw.com"                  //本地部署的开源loraserver 
