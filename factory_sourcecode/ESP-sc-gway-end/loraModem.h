...
// Copyright (c) 2016-2020  version for ESP8266
//
...
struct pins {
  uint8_t dio0 = 13;  // GPIO26 / Dio0 used for one frequency and one SF
  uint8_t dio1 = 13;  // GPIO33 / Used for CAD, may or not be shared with DIO0
  uint8_t dio2 = 13;  // GPIO32 / Used for frequency hopping, don't care
  uint8_t ss = 14;    // GPIO18 / CS. Select pin connected to GPIO18
  //  uint8_t dio0=16;    // GPIO26 / Dio0 used for one frequency and one SF
  //  uint8_t dio1=16;    // GPIO33 / Used for CAD, may or not be shared with DIO0
  //  uint8_t dio2=16;    // GPIO32 / Used for frequency hopping, don't care
  //uint8_t ss=23;      // GPIO18 / CS. Select pin connected to GPIO18
  uint8_t rst = 12;   // GPIO14 / D3. Reset pin not used
} pins;
#define LORA_SCK 33
#define LORA_MISO 35
#define LORA_MOSI 32
